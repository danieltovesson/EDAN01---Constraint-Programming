  ...
  static void send() {
    ...
    */
    store.impose(new LinearInt(
      ...
      new int[] {1000, 100, 10, 1, 1000, 100, 10, 1, -10000, -1000, -100, -10, -1}, "==", 0));
    ...
    Search<IntVar> search = new DepthFirstSearch<IntVar>(); SelectChoicePoint<IntVar> select = new SimpleSelect<IntVar>(digits,
      null,
